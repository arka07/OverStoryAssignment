...
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_DeltaAuditpage;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_DynamicGraphicalReportsPage;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_AdvancedMasterReportPage;
...
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_EnodeBPerfKPIs;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_IsolationReport;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_QueryBuilderPage;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_RCANationalRollup;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_RCAReport;
import com.ericsson.NDOrnd.dopuatautomation.pages.RANTS_TriageReport;

public class RANTS_BouyguesTest extends  TestBase{
	...
	RANTS_AdvancedMasterReportPage advancedmaster;
	RANTS_QueryBuilderPage querybuilderpage;
	RANTS_EnodeBPerfKPIs  enodeBPerfKPIs;
	RANTS_DynamicGraphicalReportsPage dynamicgraphicalreportspage;
    RANTS_IsolationReport isolationreport;
	RANTS_RCAReport rcareport;
	RANTS_RCANationalRollup rcanational;
	RANTS_TriageReport triagereport;
	RANTS_DeltaAuditpage deltaauditpage;
	...
	/*EnodeBPerfKPIs  enodeBPerfKPIs;
                ...
                public RANTS_BouyguesTest() {
                	super();
                }

                @BeforeTest(alwaysRun = true)
                public void setUp() throws InterruptedException
                {   bouyguespage = new RANTS_BouyguesCustomerPage();
                ...
                advancedmaster = new RANTS_AdvancedMasterReportPage();
                querybuilderpage = new RANTS_QueryBuilderPage(); 
                dynamicgraphicalreportspage =new RANTS_DynamicGraphicalReportsPage();
                enodeBPerfKPIs = new RANTS_EnodeBPerfKPIs();
                isolationreport = new RANTS_IsolationReport();
            	rcareport  =  new RANTS_RCAReport();
            	rcanational = new RANTS_RCANationalRollup();
            	deltaauditpage = new RANTS_DeltaAuditpage();
            	triagereport =new RANTS_TriageReport();
