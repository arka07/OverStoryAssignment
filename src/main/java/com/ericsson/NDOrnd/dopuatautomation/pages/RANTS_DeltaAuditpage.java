...
public class RANTS_DeltaAuditpage extends TestBase{

	RANTS_QueryBuilderPage querybuilderpage= new RANTS_QueryBuilderPage();
	RANTS_BouyguesCustomerPage bouyguespage =new RANTS_BouyguesCustomerPage();
